...
function createSlot5(ownerName) {
  ...
  const Slot22 = React24.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React24.isValidElement(newElement) ? React24.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React24.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
//# sourceMappingURL=chunk-CIM5QWVU.js.map
